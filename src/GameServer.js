...
function GameServer() {
    ...
    this.config = {
        ...
        serverWelcome1: 'Welcome to KY-agario', // First server welcome message
        ...
        serverMinionInterval: 0, // minion detection interval [milliseconds]
        ...
        virusVelocity: 1500, // Velocity of moving viruses (speed and distance)
        ...
        playerRecombineTime: 20, // Base time in seconds before a cell is allowed to recombine
        playerDisconnectTime: -1, // Time in seconds before a disconnected player's cell is removed (Set to -1 to never remove)
        playerMaxNickLength: 12, // Maximum nick length
