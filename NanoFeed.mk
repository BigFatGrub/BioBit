...
; [NOTES]
; Blobit uses blob size instead of blob mass to improve performance!
; In order to get the blob size from mass value, you need to calculate using this formula:
;     size = SQRT( mass * 100 )
;
